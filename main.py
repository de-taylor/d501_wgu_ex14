...
def go(config: DictConfig):
    ...
    if "preprocess" in steps_to_execute:
        ...
        _ = mlflow.run(
            ...
            parameters={
                ...
                "artifact_description": "Preprocessed dataset"
            }
        )
    ...
    if "random_forest" in steps_to_execute:
        ...
        _ = mlflow.run(
            ...
            "main",
            parameters={
                "train_data": f"{config["main"]["project_name"]}/genres_train.csv:latest",
    ...
    if "evaluate" in steps_to_execute:
        ...
        _ = mlflow.run(
            ...
            parameters={
                ...
                "test_data": f"{config["main"]["project_name"]}/genres_test.csv:latest"
            }
        )
